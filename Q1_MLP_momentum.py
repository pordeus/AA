...
for alpha in alphas:
    ...
    for h in hidden:
        ...
        while qtdEpocas < epocas:
            ...
            qtdEpocas += 1
            delta_momentum_M = momentum * delta_momentum_M - alpha * (delta @ Z)
            M = M + delta_momentum_M
            delta_momentum_W = momentum * delta_momentum_W - alpha * treino_norm_X.T @ Chi
            W = W + alpha * delta_momentum_W
